...
## 각각 subagent별 작업 방법
- Bash 툴로 worktree를 생성해줘: `git worktree add ./worktree/agent-$AGENT_NUMBER`
- 할당된 디자인 스타일로 UI를 변경해줘
- Bash 툴로 서버를 백그라운드에서 시작해줘: `PORT=400$AGENT_NUMBER pnpm -C ./worktree/agent-$AGENT_NUMBER dev`
